        ...
        <div class="form-container">
            ...
            <form method="POST" action="submit_form.php">
                ...
                <div class="btn-container">
                    <!-- Back button with formaction to stay on this page and process back action -->
                    <button type="submit" name="back" value="1" formaction="pedoform_review.php" class="btn-back">
                        <i class="fas fa-arrow-left"></i> Back
                    </button>
                    <!-- Submit button submits to submit_form.php -->
